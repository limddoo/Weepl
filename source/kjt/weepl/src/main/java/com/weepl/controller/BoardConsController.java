...
public class BoardConsController {
	...
	@ResponseBody
	public Map<String, String> confirmBoardPwd(@RequestParam("boardCd") Long boardCd,
			@RequestParam("boardPwd") String boardPwd) {
		Map<String, String> result = new HashMap<>();
	...
	public String replyBoardCons(@Valid BoardConsReplyDto boardConsReplyDto, String boardConsCd,
